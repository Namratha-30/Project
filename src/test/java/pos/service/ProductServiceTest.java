		  ...
		  @Test
			...
			public void testCheckDuplicates() {
				...
				try {
		            ...
		            assertEquals(e.getMessage(), "Repeated Barcodes exists in File uploaded{"+pojo.getBarcode()+"="+null+"}");
		        }
			}
			...
			public void testCheckBarcodeExistsOrNot() {
				...
				try {
		            ...
		            assertEquals(e.getMessage(), "The following Barcode's does not exist: {"+invform.getBarcode()+"="+invform.getQuantity()+"}");
		        }
			}
